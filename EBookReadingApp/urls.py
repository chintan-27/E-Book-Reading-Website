...
urlpatterns = [
    ...
    path(r'addtowishlist/<int:pk>', views.addToWishlist, name='addtowishlist'),
    path(r'removewishlist/<int:pk>', views.removeFromWishlist, name='removewishlist'),
    path(r'addtowishlistbook/<int:pk>', views.addToWishlistBook, name='addtowishlistbook'),
    path(r'removewishlistbook/<int:pk>', views.removeFromWishlistBook, name='removewishlistbook'),
